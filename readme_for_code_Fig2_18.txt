##########################################################################
# ---------------------------------------------------------------------------------------------------------------------
# This is Matlab code to produce IPCC AR6 WGI Figure 2.18
# Creator: Daoyi Gong, Beijing Normal University 
# Contact: gdy@bnu.edu.cn
# Last updated on: June 9th, 2021
# --------------------------------------------------------------------------------------------------------------------
#
# - Code functionality: This script plots the zonal wind trend using the ERA5 data
# - Input data: Monthly mean zonal mean wind, data available:  https://cds.climate.copernicus.eu/cdsapp#!/dataset/reanalysis-era5-pressure-levels-monthly-means?tab=form
